...
However, we’re not done. You have asked for more flexibility in how you position
...
-   [x] Support to view changes directly inside the editor using a peek/inline
        experience
